\begin{titlepage}
	...
	\definecolor{covercolor}{RGB}{0,155,150}
	...
	\begin{center}
		...
		\vskip 1.6cm
		\contour[20]{white}{\makebox[16cm][s]{\fontsize{48}{48}\heiti 工程硕士学位论文}}
		\vskip .8cm
		\makebox[6cm][s]{\fontsize{23}{23}\selectfont M.E. DISSERTATION}
	\end{center}		
	\vfill
